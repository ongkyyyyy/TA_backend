...
def get_revenue_sentiment_diagram():
    ...
    for month_key in months_range:
        ...
        diagram_data["room_revenue_ratio"].append(f"{round((room_total / gross_total) * 100, 2)}%" if gross_total else "0%")
        diagram_data["restaurant_revenue_ratio"].append(f"{round((restaurant_total / gross_total) * 100, 2)}%" if gross_total else "0%")
        diagram_data["other_revenue_ratio"].append(f"{round((other_total / gross_total) * 100, 2)}%" if gross_total else "0%")
